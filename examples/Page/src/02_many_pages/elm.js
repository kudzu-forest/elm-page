...
var $author$project$ManyPages$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($elm$core$List$map, $author$project$ManyPages$toButton, $author$project$ManyPages$pages))),
				A2($author$project$Page$mapView, $author$project$ManyPages$PageUpdated, model.page),
				$elm$html$Html$text(''),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(''),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
...
var $author$project$ManyPages$main = $elm$browser$Browser$element(
	{init: $author$project$ManyPages$init, subscriptions: $author$project$ManyPages$subscriptions, update: $author$project$ManyPages$update, view: $author$project$ManyPages$view});
_Platform_export({'ManyPages':{'init':$author$project$ManyPages$main(
